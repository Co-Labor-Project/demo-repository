...
declare type Props = EllipseOptions & {
...
declare const Ellipse: react.ForwardRefExoticComponent<EllipseOptions & {
...
} & Partial<Record<"onClick" | "onMousedown" | "onMouseup" | "onDblclick" | "onRightclick" | "onMouseover" | "onMouseout" | "onMousemove", (e: naver.maps.PointerEvent) => void>> & react.RefAttributes<naver.maps.Ellipse>>;

export { Ellipse, Props };
